...
object Commands {
    ...
    fun handleSetConfessionCommand(event: MessageReceivedEvent, channel: TextChannel, configuredChannels: MutableMap<Long, TextChannel>) {
    ...
    fun handleConfessionCommand(event: MessageReceivedEvent, channel: TextChannel, configuredChannels: MutableMap<Long, TextChannel>) {
